...
class SubscriptionManagerTest(TestCase):
    def setUp(self):
        ...
        period_start = datetime.datetime(2013, 4, 1, tzinfo=timezone.get_fixed_timezone(0))
        period_end = datetime.datetime(2013, 4, 30, tzinfo=timezone.get_fixed_timezone(0))
        start = datetime.datetime(
            2013, 1, 1, 0, 0, 1, tzinfo=timezone.get_fixed_timezone(0)
...
class ChargeManagerTest(TestCase):
    def setUp(self):
        ...
        self.march_charge = Charge.objects.create(
            id="ch_XXXXMAR1",
            customer=customer,
            created=datetime.datetime(2015, 3, 31, tzinfo=timezone.get_fixed_timezone(0)),
            amount=0,
            amount_refunded=0,
            currency="usd",
            status="pending",
        ...
        self.april_charge_1 = Charge.objects.create(
            id="ch_XXXXAPR1",
            customer=customer,
            created=datetime.datetime(2015, 4, 1, tzinfo=timezone.get_fixed_timezone(0)),
        ...
        self.april_charge_2 = Charge.objects.create(
            id="ch_XXXXAPR2",
            customer=customer,
            created=datetime.datetime(2015, 4, 18, tzinfo=timezone.get_fixed_timezone(0)),
        ...
        self.april_charge_3 = Charge.objects.create(
            id="ch_XXXXAPR3",
            customer=customer,
            created=datetime.datetime(2015, 4, 30, tzinfo=timezone.get_fixed_timezone(0)),
        ...
        self.may_charge = Charge.objects.create(
            id="ch_XXXXMAY1",
            customer=customer,
            created=datetime.datetime(2015, 5, 1, tzinfo=timezone.get_fixed_timezone(0)),
            amount=0,
            amount_refunded=0,
            currency="usd",
            status="pending",
        ...
        self.november_charge = Charge.objects.create(
            id="ch_XXXXNOV1",
            customer=customer,
            created=datetime.datetime(2015, 11, 16, tzinfo=timezone.get_fixed_timezone(0)),
            amount=0,
            amount_refunded=0,
            currency="usd",
            status="pending",
        ...
        self.charge_2014 = Charge.objects.create(
            id="ch_XXXX20141",
            customer=customer,
            created=datetime.datetime(2014, 12, 31, tzinfo=timezone.get_fixed_timezone(0)),
            amount=0,
            amount_refunded=0,
            currency="usd",
            status="pending",
        ...
        self.charge_2016 = Charge.objects.create(
            id="ch_XXXX20161",
            customer=customer,
            created=datetime.datetime(2016, 1, 1, tzinfo=timezone.get_fixed_timezone(0)),
            amount=0,
            amount_refunded=0,
            currency="usd",
            status="pending",
